            ...
            <form @submit.prevent="submit">
                <CardContent class="grid gap-4">
                    <div class="grid gap-2">
                        ...
                        <Input id="email" type="email" placeholder="Example@mail.com" autocomplete="off"
                            v-model="form.email" :class="{ 'is-invalid': errors.email }" autofocus />
